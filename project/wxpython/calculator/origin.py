...
class CalcFrame(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.label = wx.StaticText(self, label="Input")
        self.textprint = wx.TextCtrl(self, style=wx.TE_RIGHT)
        self.equation = ""
        hbox.Add(self.label, flag=wx.EXPAND | wx.RIGHT | wx.LEFT, border=8)
        hbox.Add(self.textprint, proportion=1)
        vbox.Add(hbox, 1, flag=wx.EXPAND | wx.TOP | wx.BOTTOM, border=4)
